...
export const aboutContentEn = {
  ...
  pillars: [
    ...
    { title: 'Regulatory Compliance', desc: 'Seamless adherence to Dubai statutory safety standards and ISO guidelines.' },
...
export const mainServicesEn: MainServiceCard[] = [
  ...
  },
  {
    ...
    category: 'Inspection & Certification',
    bullets: [
      'Hydraulic Excavators, Heavy Loaders & Earth Moving Plant',
...
export const equipmentShowcaseEn: EquipmentShowcaseItem[] = [
  ...
  },
  {
    ...
    name: 'Backhoe Loader',
    category: 'Earth Moving Machinery',
    image: '/images/backhoe-loader.jpg',
  ...
  },
  {
    ...
    image: '/images/mobile-crane-allterrain.jpg',
  ...
  },
  {
    ...
    image: '/images/industrial-forklift.jpg',
  ...
  },
  {
    ...
    image: '/images/manlift-boomlift.jpg',
  ...
  {
    id: 'eq-pressure-gauges',
    name: 'Pressure Gauges & Transmitters',
    category: 'Plant & Instrumentation',
    image: '/images/pressure-gauges-transmitters.jpg',
    description: 'Precision analog dial gauges, digital test gauges, differential transmitters, and hydrostatic test recorders.',
    specs: ['Range: 0 to 2500 Bar', 'Deadweight Tester Calibration', 'Accuracy Classes: 0.1% to 1.0%', 'Hydrostatic Test Certification'],
  },
  {
...
export const fullTrainingCoursesEn: FullTrainingCourse[] = [
  ...
  { id: 'c-backhoe-op', title: 'BACKHOE LOADER OPERATOR AWARENESS TRAINING', category: 'Heavy Equipment', description: 'Heavy earth moving backhoe front loader and rear digging controls, stabilizer deployment, and road transit safety.', duration: '2 Days', certification: 'Backhoe Operator Card' },
...
export const whyChooseUsEn: WhyChooseUsItem[] = [
  ...
  },
  {
    ...
    description: 'Aligned with UAE Federal codes, Dubai Municipality standards, and DET statutory licensing.',
  },
  {
    number: '04',
...
export const companyIntroductionEn: CompanyIntroduction = {
  ...
  introParagraph3:
    'Our services meet the recognized national and international codes set forth by UAE government bodies, Dubai Municipality, and international ISO directives. We build lasting trust through rigorous compliance and technical integrity.',
  introParagraph4:
...
export const galleryItemsEn: GalleryItem[] = [
  ...
  { id: 'gal-4', title: 'Scaffolding System Auditing & Green Tagging', category: 'Scaffolding', image: '/images/scaffolding.png', caption: 'Independent facade and access scaffold tie verification for work at height.' },
  ...
  { id: 'gal-6', title: 'Pressure Vessel Ultrasonic Wall Testing', category: 'Inspections', image: '/images/pressure-vessel.png', caption: 'Non-destructive ultrasonic thickness testing on compressed air receiver tanks.' },
  { id: 'gal-7', title: 'Non-Destructive Weld Examination (NDT)', category: 'Inspections', image: '/images/ndt-testing.png', caption: 'Magnetic particle testing (MT) and liquid penetrant inspection on structural joints.' },
